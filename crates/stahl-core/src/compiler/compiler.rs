use crate::{
    ...
    stahl_vm::{cache::MemoizationTable, engine::ModuleContainer, primitives::constant_primitives},
};
use crate::{
...
use crate::stahl_vm::const_evaluation::ConstantEvaluatorManager;
...
pub struct Compiler {
    ...
    pub(crate) macro_env: FxHashMap<InternedString, StahlMacro>,
...
impl Compiler {
    fn new(
        ...
        macro_env: FxHashMap<InternedString, StahlMacro>,
        module_manager: ModuleManager,
        sources: Sources,
        builtin_modules: ModuleContainer,
    ) -> Compiler {
    ...
    pub(crate) fn lower_expressions_impl(
        ...
        // stahl_parser::ast::AstTools::pretty_print(&expanded_statements);
