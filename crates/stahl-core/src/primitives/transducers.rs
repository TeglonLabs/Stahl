...
pub fn compose(args: &[StahlVal]) -> Result<StahlVal> {
    ...
    Ok(StahlVal::IterV(Gc::new(transformers)))
}

pub fn enumerating(args: &[StahlVal]) -> Result<StahlVal> {
    if !args.is_empty() {
    ...
    Ok(StahlVal::IterV(Gc::new(transducer)))
}

pub fn zipping(args: &[StahlVal]) -> Result<StahlVal> {
    if args.len() != 1 {
...
pub fn interleaving(args: &[StahlVal]) -> Result<StahlVal> {
    if args.len() != 1 {
...
pub fn map(args: &[StahlVal]) -> Result<StahlVal> {
    if args.len() != 1 {
...
pub fn extending(args: &[StahlVal]) -> Result<StahlVal> {
    if args.len() != 1 {
...
pub fn flat_map(args: &[StahlVal]) -> Result<StahlVal> {
    if args.len() != 1 {
        stop!(ArityMismatch => "mapping takes one argument");
    }
...
pub fn flatten(args: &[StahlVal]) -> Result<StahlVal> {
    if !args.is_empty() {
...
pub fn filter(args: &[StahlVal]) -> Result<StahlVal> {
    if args.len() != 1 {
...
pub fn take(args: &[StahlVal]) -> Result<StahlVal> {
    if args.len() != 1 {
...
pub fn dropping(args: &[StahlVal]) -> Result<StahlVal> {
    if args.len() != 1 {
