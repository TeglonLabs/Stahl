...
//     /// Stahl Function of any kind
//     pub(crate) predicate: StahlVal,
...
// impl FlatContract {
//     #[inline(always)]
//     pub fn new_from_stahlval(predicate: StahlVal, name: String) -> Result<StahlVal> {
...
//     pub fn new(predicate: StahlVal, name: String) -> Self {
//         FlatContract { predicate, name }
//     }

//     pub fn predicate(&self) -> &StahlVal {
//         &self.predicate
//     }
// }

// impl From<FlatContract> for StahlVal {
//     fn from(val: FlatContract) -> StahlVal {
//         StahlVal::Contract(Gc::new(ContractType::Flat(val)))
//     }
// }
...
// fn parse_list(lst: StahlVal) -> Result<(String, Vec<String>, Gc<ByteCodeLambda>, String)> {
//     if let StahlVal::ListV(l) = lst {
...
//     pub(crate) fn new_from_stahlvals(
//         pre_condition_lists: &[StahlVal],
//         post_condition_list: StahlVal,
//     ) -> Result<StahlVal> {
...
//         Ok(StahlVal::Contract(Gc::new(ContractType::Function(
...
//     #[inline(always)]
//     pub fn new_from_stahlval(
//         pre_conditions: &[StahlVal],
//         post_condition: StahlVal,
//     ) -> Result<StahlVal> {
//         let pre_conditions = pre_conditions
//             .iter()
//             .map(|x| {
//                 if let StahlVal::Contract(c) = x {
...
//         let post_condition = if let StahlVal::Contract(c) = post_condition {
//             c
//         } else {
...
// impl From<FunctionContract> for StahlVal {
//     fn from(val: FunctionContract) -> StahlVal {
//         StahlVal::Contract(Gc::new(ContractType::Function(FunctionKind::Basic(val))))
//     }
// }
...
// /// Represents a Stahl function wrapped with a contract
...
//     pub fn new(contract: FunctionKind, function: StahlVal, name: Option<String>) -> Self {
//         ContractedFunction {
//             contract,
//             function,
//             name,
...
//         if let StahlVal::Closure(func) = &self.function {
//             Some(func.arity())
//         } else {
//             None
//         }
...
//     #[inline(always)]
//     pub fn new_from_stahlvals(
//         contract: StahlVal,
//         function: StahlVal,
//         name: Option<StahlVal>,
//     ) -> Result<StahlVal> {
//         let name = match name {
//             Some(StahlVal::SymbolV(s)) => Some(s.to_string()),
//             Some(_) => stop!(TypeMismatch => "bind/c expected a symbol in the first position"),
//             None => None,
//         };

//         let contract = if let StahlVal::Contract(fc) = contract {
...
//         // let function = if let StahlVal::Closure(b) = function {
//         //     b.clone()
//         // } else {
...
//         if let StahlVal::Closure(function) = &function {
...
// impl From<ContractedFunction> for StahlVal {
//     fn from(val: ContractedFunction) -> Self {
//         StahlVal::ContractedFunction(Gc::new(val))
//     }
// }
