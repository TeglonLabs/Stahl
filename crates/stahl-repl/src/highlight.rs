...
use stahl_parser::lexer::TokenStream;
    ...
    fn highlight<'l>(&self, line: &'l str, pos: usize) -> Cow<'l, str> {
        ...
        while let Some(token) = token_stream.next() {
            ...
            match token.typ() {
                ...
                TokenType::CloseParen(paren) if paren_to_highlight.is_none() => {
                    ...
                    if token.span.end == pos {
                        let next_span = match token_stream.peek() {
                            Some(stahl_parser::tokens::Token {
                ...
                // stahl::parser::tokens::TokenType::QuoteTick => todo!(),
                // stahl::parser::tokens::TokenType::QuasiQuote => todo!(),
                // stahl::parser::tokens::TokenType::Unquote => todo!(),
                // stahl::parser::tokens::TokenType::UnquoteSplice => todo!(),
                // stahl::parser::tokens::TokenType::TestLet => todo!(),
                // stahl::parser::tokens::TokenType::Return => todo!(),
                // stahl::parser::tokens::TokenType::Begin => todo!(),
                TokenType::Lambda
                | TokenType::If
                | TokenType::Define
                | TokenType::Let
                ...
                // stahl::parser::tokens::TokenType::Quote => todo!(),
                // stahl::parser::tokens::TokenType::SyntaxRules => todo!(),
                // stahl::parser::tokens::TokenType::DefineSyntax => todo!(),
                // stahl::parser::tokens::TokenType::Ellipses => todo!(),
                // stahl::parser::tokens::TokenType::Set => todo!(),
                // stahl::parser::tokens::TokenType::Require => todo!(),
                // stahl::parser::tokens::TokenType::CharacterLiteral(_) => todo!(),
                // stahl::parser::tokens::TokenType::Comment => todo!(),
                ...
                // stahl::parser::tokens::TokenType::Keyword(_) => todo!(),
                TokenType::Number(_) => {
                ...
                // stahl::parser::tokens::TokenType::Error => todo!(),
                _ => {}
            }
        }
