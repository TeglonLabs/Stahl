...
fn create_module() -> FFIModule {
    let mut module = FFIModule::new("stahl/web/blocking/requests".to_string());
    ...
    module
        ...
        .register_fn(
            "call",
            |request: &mut BlockingRequest| -> Result<StahlResponse, BlockingError> {
...
impl BlockingRequest {
    ...
    fn call_with_json(&mut self, json: String) -> Result<StahlResponse, BlockingError> {
...
impl From<ureq::Response> for StahlResponse {
